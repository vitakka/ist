...
from wtforms import SelectField, FloatField, SubmitField  # Поля формы
...
def apply_periodic_function(image, function_type, period, direction):
    """
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            processed_image = apply_periodic_function(
                original_image, function_type, period, direction
            )
